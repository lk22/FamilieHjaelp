  ...
  return (
    <>
      <p className="text-white font-bold text-4xl mt-2 flex justify-between items-center w-full">
        {label}
        <button onClick={toggleSubNav} className={`ml-2 w-10 h-10 flex items-center justify-center rounded-full bg-blue-500 text-white transform ${isOpen ? 'rotate-90' : 'rotate-0'}`}>
