    ...
    return (
      ...
      >
        <div className="bg-white">
          <section className="bg-white text-blue-900 sm:pt-[90px] xl:pt-15 h-[250px] sm:h-[250px] md:h-[700px] rounded-b-3xl shadow-lg">
            <div className="container-fluid sm:mx-0 md:mx-0 xl:mx-0 relative rounded-xl flex flex-wrap gap-10 items-center shadow-lg rounded-2xl">
              ...
              <div className="w-4/12 w-auto p-8 absolute top-0 left-0 w-full h-full bg-gradient-to-br from-blue-700 via-blue-900/70 to-transparent sm:p-8 xl:p-36 flex flex-col justify-center items-start text-start gap-6">
              <motion.div
                initial={{ opacity: 0, y: 50 }}
                transition={{ duration: 0.8 }}
                whileInView={{ opacity: 1, y: 0 }}
              >
                <h1 className="text-white lg:w-8/12 balance font-bold leading-none text-5xl md:text-8xl">{t('helpingResources.headline')}</h1>
              </motion.div>
              </div>
            </div>
          </section>
          <section className="bg-white">
            <div className="container px-8 md:mx-auto">
              <div className="mx-auto pt-16 pb-8">
                <p className="text-blue-900 text-xl leading-10 my-26 sm:my-56 md:my-20 md:w-10/12">
                  {t('helpingResources.description')}
                </p>
                <h2 className="text-blue-900 lg:w-6/12 text-4xl font-bold">{t('helpingResources.list_resources.title')}</h2>
              </div>
              <div className="container">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                  ...
                  <aside>
                    <p className="text-blue-900 text-xl leading-10 w-full md:w-9/12 mb-8">
