                    ...
                    <div className="container max-w-[960px] px-4 py-8 mx-auto">
                        ...
                        <nav className="flex mt-8 items-center justify-center gap-4">
                            {auth.user ? (
                                ...
                                <>
                                    <Link href={route('getting-started')} className="inline-block rounded-sm border border-[#004EA7] bg-[#004EA7] px-5 py-1.5 text-sm leading-normal text-white hover:border-white dark:border-[#3E3E3A] dark:text-[#EDEDEC] dark:hover:border-[#62605b]">
                                        Start
                                    </Link>
                                </>
                            )}
