    ...
    >
      <div className="bg-white">
        <section className="bg-white text-blue-900 sm:pt-[90px] xl:pt-15 h-[250px] lg:h-[700px] rounded-b-3xl shadow-lg">
          <div className="container-fluid sm:mx-0 lg:mx-0 xl:mx-0 relative rounded-xl flex flex-wrap gap-10 items-center shadow-lg rounded-2xl">
            <video
              ...
              muted
              controls
              className="w-full h-[450px] lg:h-[700px] object-cover"
            >
            ...
            <div className="w-4/12 sm:w-full p-8 absolute top-0 left-0 w-full h-full bg-gradient-to-br from-blue-700 via-blue-900/70 to-transparent sm:p-8 xl:p-36 flex flex-col justify-center items-start text-start gap-6">
              ...
              >
                <h1 className="text-white lg:w-8/12 balance leading text-5xl lg:text-8xl lg:px-0 px-4 font-bold">{t("stillbirth.headline")}</h1>
              </motion.div>
            </div>
          </div>
        </section>
        <section className="px-8 lg:px-0 pt-56 sm:pt-75 lg:pt-26 pb-0 bg-white">
        <div className="container mx-auto">
          <div className="mx-auto px-4 pb-16">
            <p className="text-blue-900 text-xl leading-10 mt-6 lg:w-9/12 mb-16">
            ...
            <p className="text-blue-900 text-xl leading-10 lg:w-9/12 mb-2">
