...
export default function NotesFunction() {
          ...
          <section className="bg-white text-blue-900 pt-40 sm:pt-[200px] xl:py-50">
            <div className="container 2xl:w-[1600px] 2xl:max-w-[1600px] mx-auto">
                <div className="flex flex-col 2xl:flex-row px-10 gap-28">
                    <div className="2xl:w-7/12 xs:w-full 2xl:w-7/12 flex flex-col justify-center items-start text-start gap-6">
                      <motion.div
          ...
          <section className="py-20 bg-blue-50">
            <div className="container mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12  px-4">
                ...
                >
                  <h3 className="text-blue-900 text-4xl font-bold">{t('functions_page.notes.body.title')}</h3>
                  <p className="text-blue-900 text-xl leading-10 mt-6">{t('functions_page.notes.body.description')}</p>
                </motion.div>
                <motion.div
                  initial={{ opacity: 0, x: 20 }}
                  ...
                  <ul className="flex flex-col gap-4">
                    {[1, 2].map((item) => (
                      <li key={item} className="rounded-xl bg-white p-4 bg-gradient-to-r from-blue-900 to-blue-800  border border-blue-100 text-white">
                        {t(`functions_page.notes.body.bullets.${item}`)}
                      </li>
                    ))}
                  </ul>
                  <img
