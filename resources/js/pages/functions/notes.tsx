...
export default function NotesFunction() {
    ...
    return (
      <WebLayout
        pageTitle={t('functions_page.notes.meta.title')}
        description={t('functions_page.notes.meta.description')}
      >
          ...
          <section className="text-blue-900 sm:pt-[90px] xl:pt-15 h-[700px] rounded-b-3xl shadow-lg">
            <div className="container-fluid sm:mx-0 md:mx-0 xl:mx-0 relative rounded-xl flex flex-wrap gap-10 items-center shadow-lg rounded-2xl">
              ...
              <motion.div
                ...
                >
                  <h1 className="text-white lg:w-9/12 balance leading text-7xl md:text-8xl font-bold">{t('functions_page.notes.hero.title')}</h1>
                  <p className="text-blue-100 text-lg md:text-2xl mt-6 lg:w-8/12 leading-relaxed">
                    {t('functions_page.notes.hero.description')}
                  </p>
                </motion.div>
              </div>
            </div>
